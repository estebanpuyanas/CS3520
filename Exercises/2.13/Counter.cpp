/*
Create a Counter class, with a member function inc(), that keeps track of both how often inc has been called on an instance, but also ho wmany times it has been called on all instances.alignas
